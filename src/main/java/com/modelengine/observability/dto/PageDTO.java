...
public class PageDTO<T> {
     ...
     *
     * @param records  the page content
     ...
     */
    public static <T> PageDTO<T> of(List<T> records, int page, int size, long total) {
     ...
     * @return a new PageDTO instance
     */
    public static <T> PageDTO<T> of(List<T> records, PaginationRequest request, long total) {
        return of(records, request.getPage(), request.getSize(), total);
    }
}
